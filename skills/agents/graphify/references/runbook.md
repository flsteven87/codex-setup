# Graphify Build And Operations Runbook

Turn any folder of files into a navigable knowledge graph with community detection, an honest audit trail, and three outputs: interactive HTML, GraphRAG-ready JSON, and a plain-language GRAPH_REPORT.md.

## Contents

- Usage and invocation routing
- GitHub and multi-path inputs
- Runtime installation and interpreter selection
- Corpus detection and media transcription
- Structural and semantic extraction
- Graph construction, health checks, and community labeling
- Visualization and optional exports
- Manifest, cost tracking, and cleanup
- Query, update, add, watch, hook, and honesty rules
...
See `extraction-spec.md` for the exact subagent prompt (JSON schema, node-ID rules, confidence rubric, hyperedge, and vision rules). Load it only here, only when at least one chunk holds a doc, paper, or image; a pure-code corpus has skipped Part B and never reads it. Pass each subagent that prompt verbatim with FILE_LIST, CHUNK_NUM, TOTAL_CHUNKS, DEEP_MODE, and CHUNK_PATH substituted, and have it write the result to CHUNK_PATH.
...
When the user asks to install the post-commit auto-rebuild hook or wire graphify into a project's AGENTS.md, see `hooks.md`.
